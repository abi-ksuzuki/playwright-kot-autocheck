...
/*
  週の幅を作成する
*/
export function convertWeek(weekAgo){
...
/*
  年月のフォーマット変換
*/
export function formatMonth(date, sep="") {
    const yyyy = date.getFullYear();
    const mm = ('00' + (date.getMonth()+1)).slice(-2);
...
*/
export function getWeekAgo(weekAgo, dayOfWeek) {
...
/*
  指定した数月前の月初を取得する
*/
export function getMonthAgo(weekAgo) {
